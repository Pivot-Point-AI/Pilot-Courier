      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
          <button onClick={handleDownload}
            className="flex items-center gap-2 px-5 py-2 text-sm border border-gray-300 rounded text-gray-600 hover:border-[#00529B] hover:text-[#00529B] transition-all">
            <Download className="w-4 h-4" /> Download PDF
          </button>
          <Link href="/account/invoices"
            className="flex items-center gap-2 px-5 py-2 text-sm border border-gray-300 rounded text-gray-500 hover:border-gray-400 transition-all">
            ← Back to Invoices
          </Link>
        </div>
      </div>
