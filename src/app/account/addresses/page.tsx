    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        ...
        <div className="flex gap-2">
          <button onClick={() => setShowModal(true)}
            className="px-4 py-1.5 text-xs font-semibold rounded text-white bg-[#00529B] hover:bg-[#00529B]/90 transition-all flex items-center gap-1.5">
      ...
      <div className="px-5 py-4 border-b border-gray-100">
        ...
        <div className="flex gap-2 mt-3">
          <button className="px-5 py-1.5 text-xs font-semibold rounded border border-gray-300 text-gray-600 hover:border-[#00529B] hover:text-[#00529B] transition-all">Search</button>
          <button onClick={() => setSearch({ company: '', name: '', city: '', postalCode: '' })} className="px-4 py-1.5 text-xs border border-gray-300 rounded text-gray-500 hover:border-gray-400 transition-all">Reset</button>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg">
            ...
            <div className="p-5 space-y-3 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-2 gap-3">
                <div className="col-span-2"><label className={lbl}>Label (e.g. Home, Office)</label><input className={inp} value={form.label} onChange={e => f('label', e.target.value)} /></div>
                ...
                <div className="col-span-2"><label className={lbl}>Address Line 1 *</label><input className={inp} value={form.street} onChange={e => f('street', e.target.value)} required /></div>
                <div className="col-span-2"><label className={lbl}>Address Line 2</label><input className={inp} value={form.street2} onChange={e => f('street2', e.target.value)} /></div>
